...
- Give one example of an AI suggestion that was incorrect or misleading (including what the AI suggested and how you verified the result). 
  ...
  - In another scenario, Claude Code identified the correct fix and implemented it, but did not remove the problematic version. While implementing the High Score feature, the Streamlit Session State for High Score was accessed for the sidebar construction before it was initialized. Claude Code correctly identified 3 options to resolve the problem. The resolution selected was simply to move the sidebar call below the initializations. The new code was inserted correctly, but the old code on line 52 remained, so the error persisted after the initial repair attempt. After closer inspection, I found the problem and asked Claude Code about it. The AI agreed with my diagnosis and the problematic line of code was removed.
